...
export const CoupleDataSchema = z.object({
  ...
  userImageUrl: z.string().max(SECURITY_LIMITS.MAX_URL_LENGTH).refine(isValidUrl).optional(),
  aiImageUrl: z.string().max(SECURITY_LIMITS.MAX_URL_LENGTH).refine(isValidUrl).optional(),
  video: VideoDataSchema.optional(),
  audio: AudioDataSchema.optional(),

  musicType: z.enum(['preset', 'youtube']).optional(),
  musicUrl: z.string().max(SECURITY_LIMITS.MAX_URL_LENGTH).refine(isValidUrl).optional(),
  ...
  giftLink: z.string().max(SECURITY_LIMITS.MAX_URL_LENGTH).refine(isHttpsUrl).optional(),
  ...
  manualMapLink: z.string().max(SECURITY_LIMITS.MAX_URL_LENGTH).refine(isValidUrl).optional(),
