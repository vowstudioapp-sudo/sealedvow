      ...
      <div className="bg-luxury-paper border border-[#D4C5A5] p-8 md:p-12 rounded-xl shadow-sm space-y-8 relative">
        ...
        <div className="flex justify-center pt-2">
          <button
            ...
            className="px-6 py-2.5 rounded-full bg-luxury-bronze text-white hover:bg-luxury-ink transition-all text-[10px] uppercase tracking-[0.3em] font-bold"
          >
            Regenerate Draft
          </button>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-6 pt-8 border-t border-luxury-ink/20">
          <button
            onClick={onBack}
            className="flex-1 py-4 rounded-full bg-luxury-bronze text-white hover:bg-luxury-ink transition-all transform active:scale-[0.98] font-bold text-[10px] tracking-[0.4em] uppercase shadow-xl"
          >
            ← Back to Details
          </button>
          <button
